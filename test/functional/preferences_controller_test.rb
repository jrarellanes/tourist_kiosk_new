...
class PreferencesControllerTest < ActionController::TestCase
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post :create, preference: { dateRegister: @preference.dateRegister, idsite: @preference.idsite, iduser: @preference.iduser }
    end
  ...
  test "should update preference" do
    put :update, id: @preference, preference: { dateRegister: @preference.dateRegister, idsite: @preference.idsite, iduser: @preference.iduser }
    assert_redirected_to preference_path(assigns(:preference))
  end
